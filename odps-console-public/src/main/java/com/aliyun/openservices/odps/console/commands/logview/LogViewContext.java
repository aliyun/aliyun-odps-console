...
public class LogViewContext {
  ...
  private FileCache fileCache = new FileCache(MAX_FILES);
  ...
  public void setInstanceByName(String name) {
    name = name.toLowerCase();
    if (instance == null || !name.equals(instance.getId())) {
      reset(odps.instances().get(name));
    }
  }
  ...
  public InputStream getTaskDetails(Instance inst, String taskName) throws LogViewException {
