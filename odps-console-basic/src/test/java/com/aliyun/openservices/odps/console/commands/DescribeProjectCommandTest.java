...
public class DescribeProjectCommandTest {
  ...
  public void testDescribeProjectCommand()
    ...
    AbstractCommand
        command =
        DescribeCommand.parse("Desc project " + odps.getDefaultProject(), context);
  ...
  public void testDescribeProjectCommandNeg()
    ...
    ExecutionContext context = ExecutionContext.init();
    Odps odps = OdpsConnectionFactory.createOdps(context);
    AbstractCommand command = DescribeCommand.parse("Desc project", context);
  }
  ...
  public void testDescribeProjectExtendedCommand()
    ...
    AbstractCommand
        command =
        DescribeCommand.parse("Desc project -extended " + odps.getDefaultProject(), context);
    assertTrue(command instanceof DescribeProjectCommand);
    command.run();
  }
  ...
  public void testDescribeProjectExtendedAfterCommand()
    ...
    AbstractCommand
        command =
        DescribeCommand.parse("Desc project " + odps.getDefaultProject() + " -extended ", context);
    assertTrue(command instanceof DescribeProjectCommand);
    command.run();
  }
  ...
  public void testDescribeProjectExtendedNegCommand()
    ...
    AbstractCommand
        command =
        DescribeCommand.parse("Desc project " + odps.getDefaultProject() + " -abcd ", context);
  }
