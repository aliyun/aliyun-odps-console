...
public class CodingUtils {
    ...
    public static void assertParameterNotNull(Object param, String paramName){
        if (param == null){
            throw new NullPointerException(rm.getFormattedString("ParameterIsNull", paramName));
        }
    }
    ...
    public static void assertStringNotNullOrEmpty(String param, String paramName){
        ...
        assert (param != null);
        if (param.length() == 0){
            throw new IllegalArgumentException(rm.getFormattedString("ParameterStringIsEmpty", paramName));
        }
    }
}
