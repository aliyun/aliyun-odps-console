...
/**
 * Put table or partition to cold storage
 */
public class FreezeCommand extends MultiClusterCommandBase {
  ...
  public static FreezeCommand parse(String commandString,
