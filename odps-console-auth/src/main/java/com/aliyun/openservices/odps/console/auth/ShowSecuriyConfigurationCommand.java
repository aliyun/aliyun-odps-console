...
public class ShowSecuriyConfigurationCommand extends AbstractCommand {

  public ShowSecuriyConfigurationCommand(String commandText, ExecutionContext context) {
  ...
  public static ShowSecuriyConfigurationCommand parse(String commandString, ExecutionContext context) {

    if (commandString.toUpperCase().matches("\\s*SHOW\\s+SECURITYCONFIGURATION\\s*")) {
      return new ShowSecuriyConfigurationCommand(commandString, context);
    }
    return null;
  }
}
