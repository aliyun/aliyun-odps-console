...
- repo-tracked Codex skill source：`skills/use-maxc-cli/`
- skill 同步脚本：`scripts/sync_codex_skill.py`
...
- [x] 将 `use-maxc-cli` 收敛为仓库内 source of truth
- [x] 提供同步到 `~/.codex/skills/use-maxc-cli` 的脚本
